            ...
            <div className="max-w-screen-lg px-4">
                ...
                <div className="flex flex-row items-center justify-center gap-4 mb-8">
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html" className={cn(buttonVariants({ variant: 'secondary' }), 'w-56')}>Amazon S3 Docs</Link>
                            </TooltipTrigger>
                            <TooltipContent>
                    ...
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="/setup/aws/configuration" className={cn(buttonVariants({ variant: "default" }), 'w-56')}>Get Started</Link>
                            </TooltipTrigger>
                            <TooltipContent>
